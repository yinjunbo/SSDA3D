...
def main():
    ...
    pseudo_info_path = args.pseudo_info_path
    # print(pseudo_info_path)
    train_set, train_loader, train_sampler = build_mixup_dataloader(
    ...
    if args.ckpt is not None and args.pretrained_model is None:
